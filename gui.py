...
def run_unblock_script():
    unblock_script = os.path.join(os.path.dirname(__file__), 'Extras', 'unblock.py')
    if os.path.isfile(unblock_script):
        try:
            subprocess.run([sys.executable, unblock_script], check=True)
        except subprocess.CalledProcessError:
            messagebox.showerror("Error", "Failed to run unblock.py script.")
            sys.exit("Missing files: unblock.py execution failed.")
    else:
        messagebox.showerror("Error", "unblock.py script not found.")
        sys.exit("Missing files: unblock.py not found.")
